...
<template>
  <label class="inline-flex items-center gap-3" :class="props.disabled ? 'cursor-not-allowed opacity-60' : 'cursor-pointer'">
    <div class="relative inline-flex items-center">
      <input v-model="model" type="checkbox" class="peer sr-only" :disabled="props.disabled">
